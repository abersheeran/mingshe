...
class PythonParser(Parser):
    ...
    KEYWORDS = ('with', 'and', 'as', 'elif', 'from', 'class', 'try', 'else', 'break', 'def', 'await', 'in', 'while', 'True', 'return', 'continue', 'finally', 'is', 'for', 'raise', 'assert', 'nonlocal', 'del', 'global', 'if', 'except', 'lambda', 'yield', 'import', 'or', 'False', 'pass', 'None', 'async', 'not')
