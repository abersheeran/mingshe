...
class PythonParser(Parser):
    ...
    KEYWORDS = ('True', 'from', 'except', 'try', 'in', 'for', 'class', 'raise', 'def', 'and', 'False', 'while', 'or', 'None', 'if', 'global', 'as', 'is', 'lambda', 'continue', 'async', 'yield', 'break', 'await', 'with', 'return', 'assert', 'not', 'elif', 'del', 'else', 'pass', 'import', 'finally', 'nonlocal')
